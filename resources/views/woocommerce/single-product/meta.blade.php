{{--
  ...
  This template can be overridden by copying it to yourtheme/resources/views/woocommerce/single-product/meta.blade.php.
--}}
@php
  if (!defined('ABSPATH')) {
    exit;
...
<div class="product_meta">
  ...
  @if (wc_product_sku_enabled() && ($product->get_sku() || $product->is_type('variable')))
    <span class="sku_wrapper">{{ esc_html_e('SKU:', 'woocommerce') }} <span class="sku">
      {{ $product->get_sku() ? $product->get_sku() : esc_html_e('N/A', 'woocommerce') }}
    </span></span>
  @endif
