{{--
  Shipping Calculator
  This template can be overridden by copying it to yourtheme/resources/views/woocommerce/cart/shipping-calculator.blade.php.
--}}
@php defined('ABSPATH') || exit @endphp

@if (apply_filters('woocommerce_shipping_calculator_enable', true))
