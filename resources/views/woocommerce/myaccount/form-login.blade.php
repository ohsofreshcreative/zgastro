{{--
  ...
  This template can be overridden by copying it to yourtheme/resources/views/woocommerce/myaccount/form-login.blade.php.
--}}
@php
  if (!defined('ABSPATH')) {
    exit;
    ...
    <div class="u-column2 col-2">
      ...
      <form method="post" class="woocommerce-form woocommerce-form-register register">
        ...
        <p class="woocommerce-form-row form-row">
          ...
          <button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit" name="register" value="{{ esc_attr_e('Register', 'woocommerce') }}">{{ esc_html_e('Register', 'woocommerce') }}</button>
        </p>
