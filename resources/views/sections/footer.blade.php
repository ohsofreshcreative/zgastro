...
<!--- footer --->
<section data-gsap-anim="section" class="cta-bottom c-main -smt relative z-10">

	<div data-gsap-element="wrapper" class="relative overflow-hidden bg-yellow b-radius">
		<div class="relative py-12 md:py-20 px-8 md:px-20 lg:m-auto flex flex-col md:flex-row gap-6 items-start md:items-center justify-between z-1">
		...
		@if(!empty($imageUrl))
			<img class="absolute top-0 right-0 md:-right-100 w-full h-full pointer-events-none select-none"
				 src="{{ $imageUrl }}"
				 alt="{{ $imageAlt }}">
		  @endif
	</div>
...
<footer data-gsap-anim="section" class="footer -mt-30">

	<div data-gsap-element="wrapper" class="bg-third">
		<div class="__wrapper c-main">
			<div data-gsap-element="widget" class="__widgets footer-py grid gap-4 md:gap-6">
				@for ($i = 1; $i <= 5; $i++)
